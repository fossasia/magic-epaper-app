...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -11814564;
...
fn wire__crate__api__simple__apply_sketch_filter_rust_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "apply_sketch_filter_rust",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::simple::apply_sketch_filter_rust(
                        api_image_bytes,
                        api_model_path,
                        api_target_width,
                        api_target_height,
...
fn wire__crate__api__simple__process_image_rust_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::simple::process_image_rust(
                        api_image_bytes,
                        api_target_width,
                        api_target_height,
                        api_method,
...
impl SseDecode for crate::api::simple::DitherMethod {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <i32>::sse_decode(deserializer);
        return match inner {
            0 => crate::api::simple::DitherMethod::FloydSteinberg,
            1 => crate::api::simple::DitherMethod::FalseFloydSteinberg,
            2 => crate::api::simple::DitherMethod::Stucki,
            3 => crate::api::simple::DitherMethod::Atkinson,
            ...
            8 => crate::api::simple::DitherMethod::Burkes,
...
impl flutter_rust_bridge::IntoDart for crate::api::simple::DitherMethod {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            Self::FloydSteinberg => 0.into_dart(),
            Self::FalseFloydSteinberg => 1.into_dart(),
            Self::Stucki => 2.into_dart(),
            Self::Atkinson => 3.into_dart(),
            Self::Threshold => 4.into_dart(),
            Self::Halftone => 5.into_dart(),
            Self::Bayer => 6.into_dart(),
            Self::Sierra2 => 7.into_dart(),
            Self::Burkes => 8.into_dart(),
            _ => unreachable!(),
        }
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::simple::DitherMethod
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::simple::DitherMethod>
    for crate::api::simple::DitherMethod
{
    fn into_into_dart(self) -> crate::api::simple::DitherMethod {
        self
    }
}
...
impl SseEncode for crate::api::simple::DitherMethod {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(
            match self {
                crate::api::simple::DitherMethod::FloydSteinberg => 0,
                crate::api::simple::DitherMethod::FalseFloydSteinberg => 1,
                crate::api::simple::DitherMethod::Stucki => 2,
                crate::api::simple::DitherMethod::Atkinson => 3,
                ...
                crate::api::simple::DitherMethod::Burkes => 8,
                _ => {
                    unimplemented!("");
                }
            },
