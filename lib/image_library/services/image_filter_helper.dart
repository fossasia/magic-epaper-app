...
class ImageFilterHelper {
  static Map<Function, String> get filterMap => {
    ...
    ImageProcessing.bwFalseFloydSteinbergDither: appLocalizations.falseFloydSteinberg,
    ...
    ImageProcessing.bwrFloydSteinbergDither: appLocalizations.floydSteinberg,
    ImageProcessing.bwrFalseFloydSteinbergDither: appLocalizations.falseFloydSteinberg,
